    ...
    render() {
        ...
        return (
            ...
            <Grid xs={12}>
                ...
                <Typography variant={"h6"}><span style={{fontWeight: 'bold'}}> Percentage of Courses in the {this.dataParam.campus} With a Result of Yes for Each Guideline Over Time </span></Typography>
                <Chart
                    type="line"
                    width={'100%'}
                    height={500}
